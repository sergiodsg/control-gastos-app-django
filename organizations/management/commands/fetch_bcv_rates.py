...
from organizations.services.bcv_scraper import scrape_and_store_bcv_rates
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        try:
            result = scrape_and_store_bcv_rates()
        except Exception as exc:
        ...
        self.stdout.write(
            self.style.SUCCESS(
                f"Tasas BCV sincronizadas para {rate_date}. Nuevas: {created_count}. Actualizadas: {updated_count}."
            )
        )
